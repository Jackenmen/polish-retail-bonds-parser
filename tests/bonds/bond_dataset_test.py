...
@pytest.mark.parametrize(
    "expected",
    bond_test_utils.load_test_cases("ror.csv"),
    ids=bond_test_utils.bond_id,
)
def test_ror_values(expected: bonds.Bond) -> None:
    actual = bonds.create_ror_bond(
...
@pytest.mark.parametrize(
    "expected",
    bond_test_utils.load_test_cases("dor.csv"),
    ids=bond_test_utils.bond_id,
)
def test_dor_values(expected: bonds.Bond) -> None:
    actual = bonds.create_dor_bond(
        series_name=expected.series_name,
        isin=expected.isin,
        sale_from=expected.sale_from,
        sale_to=expected.sale_to,
